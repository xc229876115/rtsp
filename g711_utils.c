...
static unsigned char _l2u[4096] = {
...
static unsigned char linear2ulaw(signed short l)
{
    unsigned char	mask;
...
static unsigned char ulaw2alaw(unsigned char u)
{
    return(_u2A[u]);
}

static unsigned char alaw2ulaw(unsigned char a)
{
    return(_A2u[a]);
}


static int _g711u_encode(void *s, void *d, int srclen, unsigned int *dstlen)
{
    int i;
    int tmp;
    signed short *ps=(signed short*)s;
...
static int _g711u_encode_16k(void *s, void *d, int srclen,unsigned  int *dstlen)
{
    int i;
    int tmp;
    signed short *ps=(signed short*)s;
...
static int _g711u_decode(void *s, void *d, int srclen,unsigned int *dstlen)
{
    int i;
    signed short *pd = (signed short*)d;
    signed char *ps = (signed char*)s;

    *dstlen = 0;

    for (i = 0; i < srclen; i ++)
    {
        pd[i] = (signed short)ulaw2linear(ps[i]);
        (*dstlen) += 2;
    }
...
static int _g711a_encode(void *s, void *d, int bufsize, unsigned int *dstlen)
{
    int i,tmp;
    char *src = (char *)s;
    char *dest = (char *)d;
...
static int _g711a_encode_16k(void *s, void *d, int bufsize,unsigned int *dstlen)
{
    int i,tmp;
    char *src = (char *)s;
    char *dest = (char *)d;
...
static int _g711a_decode(void *s, void *d, int srclen,unsigned int *dstlen)
{
    int i;
...
int g711_encode(unsigned char type, unsigned short *src, unsigned int srcLen, unsigned char *drc, unsigned int *pOut)
{
    ...
    if (type == G711_A_LAW){
        ret = _g711a_encode(src, drc, srcLen, pOut);
    } else{
        ret = _g711u_encode(src, drc, srcLen, pOut);
    }
...
int g711_encode_16K(unsigned char type, unsigned short *src, unsigned int srcLen, unsigned char *drc, unsigned int *pOut)
{
    ...
    if (type == G711_A_LAW){
        ret = _g711a_encode_16k(src, drc, srcLen, pOut);
    } else{
        ret = _g711u_encode_16k(src, drc, srcLen, pOut);
    }
...
int g711_decode(unsigned char type, unsigned short *src, unsigned int srcLen, unsigned char *drc, unsigned int *pOut)
{
    ...
    if (type == G711_A_LAW){
        ret = _g711a_decode(src, drc, srcLen, pOut);
    } else{
        ret = _g711u_decode(src, drc, srcLen, pOut);
    }
